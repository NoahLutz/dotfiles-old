...
alias hvpn_on="sudo systemctl start openvpn@wilson_arch.service;notify-send 'Starting VPN - Home'"
alias hvpn_off="sudo systemctl stop openvpn@wilson_arch.service;notify-send 'Ending VPN - Home'"
